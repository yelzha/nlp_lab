...
TOP_P=$8 # 0.95,0.9
EXPERIMENT_DIRECTORY=$9 # "experiments"

K_VALUES=(1 5 10 15 20 25)  # Reduced to 25 : (1 5 10 15 20 25 30 35 40 45 50)
BASE_DIR_NAME="$MAIN_DIRECTORY/${EXPERIMENT_DIRECTORY}/${DTYPE}/${MODEL}/${QTYPE}"
